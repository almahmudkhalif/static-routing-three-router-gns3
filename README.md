...
📖 **Full article on Dev.to:** [How I Built a Multi-Router Static Routing Network from Scratch Using GNS-3](https://dev.to/almahmudkhalif/lab-task-2-how-i-built-a-multi-router-static-routing-network-from-scratch-using-gns-3-4i21)
